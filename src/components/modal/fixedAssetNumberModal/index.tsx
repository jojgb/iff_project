...
import { fixedAssetNumberOption } from "../../../constant";

interface FixedAssetNumberModalProps {
  isVisible: boolean;
  onClose: () => void;
  onApply?: (category: string) => void;
}

const FixedAssetNumberModal: FunctionComponent<FixedAssetNumberModalProps> = ({
  isVisible,
  onClose,
  onApply,
}) => {
  ...
  useEffect(() => {
    ...
    setFilteredOptions(
      fixedAssetNumberOption.filter((option) =>
...
export default FixedAssetNumberModal;
